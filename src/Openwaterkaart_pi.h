...
class Openwaterkaart_pi : public opencpn_plugin_116
{
public:
      Openwaterkaart_pi(void *ppimgr);
	   ~Openwaterkaart_pi(void);
...
//    Other public methods
	  ...
	  void OnOpenwaterkaartDialogClose();
...
private:
	  ...
	  bool             m_bOpenwaterkaartShowIcon;
	  bool             m_bShowOpenwaterkaart;
